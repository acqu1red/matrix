    ...
    try:
        ...
        if payment_status == 'success':
            ...
            if email:
                ...
                print("⚠️ Email не найден в данных платежа")
            
            # Если нет ни user_id, ни email, логируем проблему
