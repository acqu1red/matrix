...
TELEGRAM_BOT_TOKEN = os.environ.get("TELEGRAM_BOT_TOKEN", "7593794536:AAGSiEJol...")
WEBHOOK_URL = os.environ.get("WEBHOOK_URL", "https://formulaprivate-productionpaymentuknow.up.railway.app")
LAVA_TOP_API_KEY = os.environ.get("LAVA_TOP_API_KEY", "whjKvjpi2oqAjTOwfbt0YUkulXCxjU5PWUJDxlQXwOuhOCNSiRq2jSX7Gd2Zihav")
LAVA_OFFER_ID_BASIC = os.environ.get("LAVA_OFFER_ID_BASIC", "302ecdcd-1581-45ad-8353-a168f347b8cc")
