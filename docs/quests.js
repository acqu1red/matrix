...
const QUESTS = [
  ...
  { 
    ...
    description: "Изучи невербальные сигналы, жесты и микровыражения для полного контроля над собеседником. На каждого умного человека найдется еще более умный, который изменит его психику так, что никто не поймет.",
    type: "analysis", 
    difficulty: "medium",
    rewards: { fragments: 3, experience: 500 },
    available: true,
  ...
  { 
    ...
    description: "Проанализируй поведенческие паттерны и составь детальное досье. Выяви слабости, страхи и желания - то, что поможет управлять человеком незаметно для него самого.",
    type: "analysis", 
    difficulty: "hard",
