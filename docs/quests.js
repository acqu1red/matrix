...
const PRODUCTS = {
  'psychology-lie': {
    ...
    modalDescription: `
      <strong>99% людей не умеют распознавать ложь.</strong>
      <br>Этот тренинг поместит вас в 1% лучших. Вы получите:
      <br>- <strong>Биологические маркеры:</strong> Как тело выдает лжеца против его воли.
      <br>- <strong>Техники спецслужб:</strong> Методы, которые используют для допросов.
      <br>- <strong>Практические кейсы:</strong> Разбор реальных ситуаций для оттачивания навыка.
      <br><strong>После этого курса ни одна ложь не пройдет мимо вас.</strong>
    `,
    priceStars: 28,
    priceRub: '50 руб.',
    oldPriceRub: '499 руб.',
  ...
  'profiling-pro': {
    ...
    modalDescription: `
      <strong>Знание — это власть.</strong>
      <br>Этот курс даст вам власть над социальными взаимодействиями. Вы научитесь:
      <br>- <strong>Составлять психологический портрет</strong> за 5 минут.
      <br>- <strong>Видеть скрытые мотивы</strong> и детские травмы.
      <br>- <strong>Предсказывать поведение</strong> людей с поразительной точностью.
      <br><strong>Это ваше нечестное преимущество в любой коммуникации.</strong>
    `,
    priceStars: 14,
    priceRub: '25 руб.',
  ...
  'psychotypes-full': {
    ...
    modalDescription: `
      <strong>Это — высшая лига манипуляций.</strong>
      <br>Знание психотипов — это ключ к подсознанию любого человека. Вы получите:
      <br>- <strong>Полный контроль:</strong> Как заставить человека делать то, что вам нужно.
      <br>- <strong>Запрещенные методы:</strong> Техники, которые ограничены для использования спецслужбами.
      <br>- <strong>Мгновенное раскрытие:</strong> Узнайте о человеке все за считанные секунды.
      <br><strong>Используйте эту силу с умом. Или без. Выбор за вами.</strong>
    `,
    priceStars: 500,
    priceRub: '829 руб.',
  ...
  '100-female-manipulations': {
    ...
    modalDescription: `
      <strong>Хватит быть жертвой.</strong>
      <br>Больше никаких игр, в которых вы проигрываете. Внутри вы найдете:
      <br>- <strong>100 реальных сценариев:</strong> От чувства вины до "ты не мужчина".
      <br>- <strong>Четкие контрприемы:</strong> Что говорить и делать в каждой ситуации.
      <br>- <strong>Мгновенное обезвреживание:</strong> Научитесь видеть игру наперед и всегда выходить победителем.
      <br><strong>Верните себе контроль. Навсегда.</strong>
    `,
    priceStars: 12,
    priceRub: '20 руб.',
