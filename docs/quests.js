...
const QUESTS = [
    { 
     ...
     theme: "Психоконтроль", 
     style: "conspiracy", 
     name: "Методы Эпштейна", 
     intro: "Изучи техники психологического влияния элиты на массы.", 
     description: "Освой секретные методы манипуляций, которые использовала островная элита для контроля влиятельных людей и формирования нужных решений.",
     type: "interactive", 
     difficulty: "medium",
  ...
  { 
    ...
    intro: "Создай структуру теневого мирового управления.", 
    description: "Распредели агентов влияния по пяти секторам глобального контроля: политический, военный, экономический, исследовательский и пропагандистский. Сформируй идеальную сеть мирового господства.",
    type: "strategy", 
    difficulty: "hard",
  ...
  { 
    ...
    theme: "Декодирование", 
    style: "conspiracy", 
    name: "Язык Иллюминатов", 
    intro: "Расшифруй тайные знаки и символы элиты.", 
    description: "Изучи невербальные сигналы, жесты и микровыражения, которые использует элита для скрытого общения. Раскрой коды тайного языка власти.",
    type: "analysis", 
    difficulty: "medium",
    rewards: { fragments: 3, experience: 500 },
    available: true,
  ...
  { 
    ...
    style: "conspiracy", 
    name: "Досье на Элиту", 
    intro: "Создай психологический портрет влиятельной персоны.", 
    description: "Проанализируй цифровые следы и составь детальное досье на представителя мировой элиты. Выяви слабости и рычаги воздействия.",
    type: "analysis", 
    difficulty: "hard",
  ...
  { 
    ...
    intro: "Раскрой механизмы мирового управления через секретные документы.", 
    description: "Изучай засекреченные архивы операций по контролю массового сознания. Анализируй документы ЦРУ, MI6 и других спецслужб о манипуляциях элиты.",
    type: "investigation", 
    difficulty: "medium",
    rewards: { fragments: 5, experience: 1000 },
    available: false,
  ...
  { 
    ...
    style: "conspiracy", 
    name: "Схемы Понци Элиты", 
    intro: "Раскрой финансовые махинации мировых банкиров.", 
    description: "Исследуй механизмы перекачки денег от народа к элите через сложные финансовые схемы. Найди слабое звено в системе контроля.",
    type: "puzzle", 
    difficulty: "easy",
  ...
  { 
    ...
    style: "conspiracy", 
    name: "Фабрика Лжи", 
    intro: "Изучи методы формирования общественного мнения.", 
    description: "Проанализируй как элита через медиа внедряет нужные идеи в массовое сознание. Сравни эффективность различных пропагандистских приемов.",
    type: "quiz", 
    difficulty: "easy",
  ...
  { 
    ...
    style: "conspiracy", 
    name: "Профиль Жертв", 
    intro: "Изучи целевую аудиторию для манипуляций.", 
    description: "Проанализируй демографические данные и психологические профили групп населения, наиболее податливых к воздействию пропаганды элиты.",
    type: "analysis", 
    difficulty: "medium",
  ...
  { 
    ...
    theme: "Война Кланов", 
    style: "conspiracy", 
    name: "Борьба Династий", 
    intro: "Изучи противостояние могущественных семей.", 
    description: "Исследуй скрытую войну между влиятельными кланами за контроль над мировой экономикой и политикой. Определи кто реально правит миром.",
    type: "analysis", 
    difficulty: "hard",
  ...
  { 
    ...
    intro: "Раскрой долгосрочные планы мировой элиты.", 
    description: "Изучи тенденции и закономерности в действиях теневого правительства. Предскажи следующие шаги элиты по установлению нового мирового порядка.",
    type: "analysis", 
    difficulty: "hard",
