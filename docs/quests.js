...
// Функция создания эффекта падающих монет
function createWealthEffect() {
  ...
  setInterval(() => {
    ...
    coin.style.fontSize = (Math.random() * 10 + 20) + 'px';
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  initTG();
  setupCaseNavigation();
  createWealthEffect(); // Запускаем эффект падающих монет
...
const QUESTS = [
  { 
    ...
    style: "conspiracy", 
    name: "💰 Мастер-класс по Торговле", 
    intro: "Освой стратегии создания многоуровневого бизнеса.", 
  ...
  { 
    ...
    style: "conspiracy", 
    name: "🎯 Маркетинг Целевой Аудитории", 
  ...
  { 
    ...
    theme: "Война Кланов", 
    style: "conspiracy", 
    name: "🏢 Стратегии Корпоративного Успеха", 
  ...
  { 
    ...
    intro: "Освой навыки считывания эмоций и понимания людей.", 
  ...
  { 
    ...
    theme: "Психоманипуляции", 
    style: "special", 
    name: "🎭 Персональный Брендинг", 
    intro: "Создай свой уникальный образ и найди свою нишу.", 
