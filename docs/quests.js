...
const ALL_QUESTS = {
  ...
  'competitors': {
    ...
    description: 'Научись выявлять слабые стороны врагов, нанимать агентов и запускать нативную рекламу, чтобы доминировать на рынке.',
    button: 'Начать битву за рынок',
    archetypes: ['biznesmen', 'strategist'],
    category: 'Стратегия',
    tags: ['Сложный', 'Интерактив']
  },
  'trends': {
    id: 'trends',
