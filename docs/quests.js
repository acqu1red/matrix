...
const ALL_QUESTS = {
  ...
  'competitors': {
    id: 'competitors',
    title: 'ВОЙНА КОРПОРАЦИЙ',
    description: 'Рынок — это поле битвы. Анализируй, находи слабости и уничтожай конкурентов, чтобы стать монополистом.',
    archetypes: ['biznesmen', 'strategist'],
    category: 'Стратегия',
    button: 'Начать поглощение',
    tags: ['Сложный', 'Бизнес']
  },
  'trends': {
    id: 'trends',
