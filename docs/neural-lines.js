...
class NeuralLinesAnimation {
  constructor(canvas) {
    ...
    this.params = {
      lineCount: 15,       // Уменьшено количество линий на ~30% (18 * 0.7)
      lineLength: 800,     // Увеличена длина линии
      proximity: 20,       // Уменьшена дистанция для столкновения
      sparksRateCap: 30,   // Уменьшено количество вспышек
      starCount: 18        // Количество звездочек
    };
  ...
  animate() {
    ...
    // Очистка с оптимизированной прозрачностью
