...
-- Пример: SELECT * FROM admins WHERE [правильное_название_поля] IN ('708907063', '7365307696');
...
-- затем используйте правильные названия полей
-- Пример: SELECT * FROM subscriptions WHERE [правильное_название_поля] IN ('708907063', '7365307696');

-- 16. Показываем все записи для анализа
SELECT * FROM admins;
SELECT * FROM subscriptions;
